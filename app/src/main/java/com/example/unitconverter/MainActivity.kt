...
fun UnitConverter(modifier: Modifier=Modifier){
    ...
    Column(modifier = Modifier.fillMaxSize(), verticalArrangement = Arrangement.Center, horizontalAlignment = Alignment.CenterHorizontally){
        //Here the UI elements will stacked below each other
        ...
        Spacer(modifier=Modifier.height(16.dp))
        Row {
            //Here the UI elements will be stacked next to each other
            Box{
                Button(onClick={iExpanded=true}) { Text(text=inputUnit)
            ...
            Box{
                Button(onClick = {oExpanded=true}) { Text(text=outputUnit)
                Icon(Icons.Default.ArrowDropDown,"Arrow Down")
                }
